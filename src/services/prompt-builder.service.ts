...
export class PromptBuilderService {
  private cachedInstructionText: string | null = null;
  ...
  public buildUserPrompt(schemaMetadata: string, userQuestion: string): string {
    return (
      `=== DATABASE SCHEMA METADATA (FROM CACHE) ===\n` +
