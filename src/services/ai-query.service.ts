...
import { GeminiResponse, QueryResultResponse, UserQuestionRequest } from '../types/ai.types';
...
export class AiQueryService {
   ...
   */
  public async processUserQuestion(request: UserQuestionRequest): Promise<QueryResultResponse> {
    ...
    let stage1Response: GeminiResponse;
    ...
    let stage2Response: GeminiResponse;
  ...
  private buildTextResponse(question: string, gemini: GeminiResponse): QueryResultResponse {
  ...
  private buildFormattedQueryResponse(
    ...
    formattedGemini: GeminiResponse,
    totalTimeMs: number
  ): QueryResultResponse {
  ...
  private buildErrorResponse(question: string, errorMessage: string): QueryResultResponse {
    return {
      question,
      error: errorMessage,
    };
